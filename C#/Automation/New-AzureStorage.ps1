...
$storageAcct = New-AzStorageAccount -Name $Name -Location $Location -Verbose -ResourceGroupName $ResourceGroupName -SkuName "Standard_LRS"
if ($storageAcct)
{
...
$key = Get-AzStorageAccountKey -Name $Name -ResourceGroupName $ResourceGroupName
